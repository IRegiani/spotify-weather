...
const SpotifyIcon = () => (
  <SvgIcon height="168px" width="168px" version="1.1" viewBox="0 0 168 168">
...
const Login = () => {
  ...
  return (
    <Grid container component="main" className={classes.root}>
      <Button variant="outlined" size="large" color="primary" id="authButton" onClick={redirect} className={classes.button} startIcon={<SpotifyIcon />}>
